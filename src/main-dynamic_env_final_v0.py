...
plt.show()
name = f'safe_space_{t}_N_{N}'
env.vis.fig.savefig(f'./results/animation/car4/pdf/{name}.pdf', dpi=300)
env.vis.fig.savefig(f'./results/animation/car4/png/{name}.png', dpi=300)
