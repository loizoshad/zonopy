...
import numpy as np
from utils.environments.environments import ParkEnv1, SamplesHZ, SamplesVis
from utils.operations.operations import ZonoOperations
from utils.visualization import AuxiliaryVisualizer, ZonoVisualizer
...
road = hz[0]
parking = op.union_hz_hz(hz[1], hz[2])
