...
plt.show()
print("*******************************************************************************")
print("Dimensions of original Hybrid Zonotopes:")
...
# ##############################################################################
print("--------------------------------------------------")
print("Dimensions of intersections")
...
vis = ZonoVisualizer()
vis.vis_hz(
    [hz_15_IS_16_IS_17], title="Hybrid Zonotope", legend_labels=["$HZ_{15} \\cap HZ_{16} \\cap HZ_{17}$"], add_legend=True
)
plt.show()
