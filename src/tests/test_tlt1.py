...
vis.vis_hz([hz1, hz2], title="Original Trees", colors=colors, legend_labels=["$HZ_{1}", "HZ_{2}"], add_legend=True)
...
vis.vis_hz([or_tree.root.set], title="AND Tree", colors=colors, legend_labels=["Intersection"], add_legend=True)
